...
const App = () => {
    ...
    const fetchBooks = async (e) => {
        ...
        if (e) {
            ...
            setStartIndex(0); // Reset start index for a new search
        }

        await loadBooks(0); // Load books starting from index 0 for new searches
    };

    const loadMoreBooks = async () => {
        await loadBooks(startIndex); // Load more books from the current startIndex
    };
